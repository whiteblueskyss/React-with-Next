...
export function ColorTextWithArrow({ text }) {
  return (
    <div>
      <a
        href="#"
...
export function TranjactionSVG() {
  return (
    <svg
      className="w-10 h-10 mb-2 text-purple-600 md:w-12 md:h-12 dark:text-purple-500"
      fill="currentColor"
...
export function Card({ boldText, text }) {
  return (
    <>
      <h3 className="mb-2 text-2xl font-bold dark:text-white">{boldText}</h3>
